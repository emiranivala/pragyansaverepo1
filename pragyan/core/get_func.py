...
from pragyan.core.mongo import db as odb
...
async def clone_message(app, msg, target_chat_id, topic_id, edit_id, log_group):
    ...
    Pragyan = await app.send_message(target_chat_id, msg.text.markdown, reply_to_message_id=topic_id)
    await Pragyan.copy(log_group)
    await edit.delete()
...
async def send_settings_message(chat_id, user_id):
    ...
    buttons = [
        ...
        [Button.url("Report Errors", "https://t.me/vrindavanneeko16008")]
    ]
...
async def callback_query_handler(event):
    ...
    if event.data == b'setchat':
        ...
        await event.respond("Watermark is Pro+ Plan.. contact @pragyan")
        return
    ...
    try:
        ...
        if freecheck == 1:
            reply_markup = InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("💎 Get Premium to Forward", url="https://t.me/pragyan")]
                ]
            )
